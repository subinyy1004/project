...
export default function CalendarHeader({ year, month, onPrevMonth, onNextMonth, onToday, onMonthYearClick }) {
  return (
    <div
      style={{
        display: 'flex',
    ...
    >
      <div onClick={onMonthYearClick} style={{ display: 'flex', alignItems: 'center', gap: 4, cursor: 'pointer' }}>
        <span
          style={{
